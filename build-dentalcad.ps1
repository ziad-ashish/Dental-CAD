...
$meshRepairJs    = [System.IO.File]::ReadAllText("$srcDir\js\mesh-repair.js",    [System.Text.Encoding]::UTF8)
...
[void]$sb.AppendLine('// === mesh-repair.js ===')
[void]$sb.AppendLine($meshRepairJs)
