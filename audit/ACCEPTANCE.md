...
The suite currently verifies 95 cases across:
...
- Electron desktop shell configuration and renderer isolation
- Python launcher entry point for desktop startup
...
See [READINESS.md](./READINESS.md) for the boundary between tested prototype evidence and the external clinical, business, and regulatory work required for a commercial product.
